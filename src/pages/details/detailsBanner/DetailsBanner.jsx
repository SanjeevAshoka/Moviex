...
import CircleRating from "../../../components/circleRating/Rating";
                            ...
                            <div className="right">
                                ...
                                <div className="info">
                                    ...
                                    {data.release_date && (<div className="infoItem">
                                        ...
                                        <span className="text">{dayjs(data.release_date).format("MM D. YYYY")}</span>
                                    </div>)}
                                ...
                                {director?.length > 0 && (
                                    <div className="info">
                                        ...
                                        <span className="text">{director.map((d, i) => (<span key={i}>{d.name}{director.length - 1 !== i && ", "}
                                        </span>))}</span>
                                    </div>
                                )}
                                {writer?.length > 0 && (
                                    <div className="info">
                                        ...
                                        <span className="text">{writer.map((d, i) => (<span key={i}>{d.name}{director.length - 1 !== i && ", "}
                                        </span>))}</span>
                                    </div>
                                )}
                                {writer?.length > 0 && (
                                ...
                                {data?.created_by?.length > 0 && (
                                    <div className="info">
                                        ...
                                        <span className="text">{data?.created_by?.map((d, i) => (<span key={i}>{d.name}{data?.created_by.length - 1 !== i && ", "}
                                        </span>))}</span>
                                    </div>
                                )}
                            </div>
